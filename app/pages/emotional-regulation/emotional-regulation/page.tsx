              ...
              <div className="space-y-4">
                ...
                <div>
                  ...
                  <ul className="list-disc list-inside space-y-1 text-gray-700 ml-4">
                    ...
                    <li><Link href="/pages/emotional-regulation/positive-self-talk" className="text-blue-600 hover:text-blue-800 underline">Positive Self-Talk</Link> - Challenge negative thoughts</li>
                  </ul>
                </div>
              </div>
            </div>
